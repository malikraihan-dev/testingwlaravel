...
<div class="mb-6">
    ...
    <p class="text-slate-500">Lihat dan atur status kehadiran semua user</p>
</div>
                ...
                <tr class="hover:bg-slate-50">
                    ...
                    <td class="py-4 px-6 text-right">
                        <form method="POST" action="{{ route('admin.attendances.destroy', $a) }}" onsubmit="return confirm('Hapus data ini?')">
                            @csrf
                            @method('DELETE')
                            <button class="w-9 h-9 flex items-center justify-center rounded-lg hover:bg-red-100 text-red-600 ml-auto" title="Hapus">
